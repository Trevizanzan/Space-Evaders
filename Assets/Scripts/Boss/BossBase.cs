...
public abstract class BossBase : MonoBehaviour
{
    ...
    // Propriet� read-only usabile dai figli
    ...
    protected virtual void Start()
    {
        ...
        {
            Debug.LogError("[BossBase] BossHealthBar.Instance � NULL! Non trovato nella scena!");
        }
    ...
    /// Durante l'entrata, il player non pu� sparare.
    /// </summary>
    protected virtual IEnumerator EntranceRoutine()
    {
        ...
        // perch� i boss figli fanno override di OnEntranceComplete senza chiamare base)
        PlayerShooting ps = FindFirstObjectByType<PlayerShooting>();
    ...
    // Chiamato quando l'entrata � finita, ogni boss inizia il suo pattern qui
